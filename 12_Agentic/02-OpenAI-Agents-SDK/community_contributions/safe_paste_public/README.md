...
**Solution:** A small [OpenAI Agents SDK](https://openai.github.io/openai-agents-python/) pipeline (same orchestration style as `02-OpenAI-Agents-SDK/deep_research`):
...
```bash
uv run python 02-OpenAI-Agents-SDK/community_contributions/safe_paste_public/app.py
```

Or from **this** directory:

```bash
cd 02-OpenAI-Agents-SDK/community_contributions/safe_paste_public
...
```bash
# repo root
uv run python 02-OpenAI-Agents-SDK/community_contributions/safe_paste_public/run_demo.py \
  02-OpenAI-Agents-SDK/community_contributions/safe_paste_public/sample_inputs/leaky_log.txt
```
