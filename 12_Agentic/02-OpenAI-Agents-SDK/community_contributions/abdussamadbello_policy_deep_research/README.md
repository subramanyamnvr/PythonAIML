...
Multi-agent flow modeled on the course [`deep_research/`](https://github.com/ed-donner/agents/tree/main/02-OpenAI-Agents-SDK/deep_research) pattern: **planner → parallel web search → structured policy brief**. Email is omitted so you only need `OPENAI_API_KEY` (no SendGrid).

**Target upstream for PRs:** [github.com/ed-donner/agents](https://github.com/ed-donner/agents) — add only this folder under `02-OpenAI-Agents-SDK/community_contributions/`.
...
```bash
cd 02-OpenAI-Agents-SDK/community_contributions/abdussamadbello_policy_deep_research
python app.py
```
