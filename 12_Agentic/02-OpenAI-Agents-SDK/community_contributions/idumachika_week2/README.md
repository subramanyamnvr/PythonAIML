...
This submission extends **`02-OpenAI-Agents-SDK/4_lab4.ipynb`** (deep research) and touches **`3_lab3.ipynb`** ideas (structured outputs for email).
...
```bash
uv run python 02-OpenAI-Agents-SDK/community_contributions/idumachika_week2/week2_deep_research.py \
