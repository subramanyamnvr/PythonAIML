...
```bash
uv run python 06-MCP/community_contributions/najeeb_mcp/run_demo.py
```
...
uv run python 06-MCP/community_contributions/najeeb_mcp/remote_sse_server.py
...
uv run python 06-MCP/community_contributions/najeeb_mcp/notes_server.py
```
