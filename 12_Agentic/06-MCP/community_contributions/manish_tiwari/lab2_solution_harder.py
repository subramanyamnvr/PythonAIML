...
Or from the repo root:
    ...
    uv run 06-MCP/community_contributions/manish_tiwari/lab2_solution_harder.py
"""
...
# 06-MCP is two levels up from this file: .../06-MCP/community_contributions/manish_tiwari/
