...
Run (from the `06-MCP` directory, same as the course notebooks)
----------------------------------------------------------------
    cd 06-MCP
...
# Paths: this file lives in .../06-MCP/community_contributions/manish_tiwari/
_SOLUTION_DIR = Path(__file__).resolve().parent
_REPO_ROOT = Path(__file__).resolve().parents[3]
_MCP_CWD = _SOLUTION_DIR.parents[1]  # .../06-MCP
