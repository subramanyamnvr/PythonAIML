...
3. Make sure **`OPENAI_API_KEY`** is set. Easiest match with the code: put a **`.env`** file at the **repository root** (the folder that contains `06-MCP/`), or export the variable in your shell.
4. Run:
