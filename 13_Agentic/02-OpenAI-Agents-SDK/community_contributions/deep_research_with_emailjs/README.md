...
---
```cmd
cd 02-OpenAI-Agents-SDK/community_contributions/deep_research_with_emailjs && py .
or
py 02-OpenAI-Agents-SDK/community_contributions/deep_research_with_emailjs/.
```
