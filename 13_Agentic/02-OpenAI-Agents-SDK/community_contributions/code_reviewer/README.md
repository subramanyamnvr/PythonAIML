...
## MCP Servers
Refer to the README.md file in /06-MCP/community_contributions/code_reviewer_mcp_servers' directory for the description of the MCP servers.
...
cd agents/02-OpenAI-Agents-SDK/community_contributions/code_reviewer
uv venv
uv sync
```
