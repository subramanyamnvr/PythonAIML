...
Run three terminals from the repo root (agents/), after `uv sync`:
  ...
  uv run python 02-OpenAI-Agents-SDK/community_contributions/makinda/week2_exercise/a2a_services.py researcher
  uv run python 02-OpenAI-Agents-SDK/community_contributions/makinda/week2_exercise/a2a_services.py judge
  uv run python 02-OpenAI-Agents-SDK/community_contributions/makinda/week2_exercise/a2a_services.py content_builder
