...
From the agents repo root:
  ...
  uv run python 02-OpenAI-Agents-SDK/community_contributions/makinda/week2_exercise/app.py

Optional distributed mode (start a2a_services.py for each role first):

  USE_A2A_REMOTE=1 uv run python 02-OpenAI-Agents-SDK/community_contributions/makinda/week2_exercise/app.py
