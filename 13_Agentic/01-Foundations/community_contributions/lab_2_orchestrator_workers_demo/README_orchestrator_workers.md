...
```bash
cd 01-Foundations/community_contributions/lab_2_orchestrator_workers_demo
...
uv run python 01-Foundations/community_contributions/lab_2_orchestrator_workers_demo/orchestrator_workers_demo.py
```
