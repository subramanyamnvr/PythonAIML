...
Community submission for **Week 4** (`04-LangGraph`): a **Sidekick-style** LangGraph app aligned with **`4_lab4.ipynb`** / `sidekick.py`, without Playwright.
...
uv run python 04-LangGraph/community_contributions/idumachika_week4/mini_sidekick.py
```
...
Add this folder under `04-LangGraph/community_contributions/` and open a PR to [ed-donner/agents](https://github.com/ed-donner/agents).
